...
async def green():
    pid = {"kp": 1, "ki": 0, "kd": 0}
    Debug = True
    await ilan.drive_straight(-26, 200, **pid)
    ...
    # await ilan.wait_for_button(Debug)
    # await ilan.turn(69.9,150)
    # await wait(1000)
    # await ilan.wait_for_button(Debug)
    # await ilan.drive_straight(16,200, **pid)
    # await ilan.wait_for_button(Debug)
    # await ilan.drive_straight(-9,200, **pid)
    # await ilan.wait_for_button(Debug)
    # await ilan.turn(135, 150)
    # await ilan.wait_for_button(Debug)
    # await ilan.drive_straight(-19,200, **pid)
    # await ilan.wait_for_button(Debug)
    # await ilan.turn(-35,150)
    # await ilan.wait_for_button(Debug)
    # await ilan.drive_straight(-9,700, **pid)
    # await ilan.wait_for_button(Debug)
